...
class Sina_Ext_Pro_Shop_Box_Carousel_Widget extends Widget_Base{
	...
	public function get_name() {
		return 'sina_ext_pro_shop_box_carousel';
	}
	...
	public function get_title() {
		return esc_html__( 'Sina Shop Box Carousel', 'sina-ext-pro' );
	}
	...
	protected function _register_controls() {
		...
		// =======================
			Sina_Pro_Woo_Common_Data::get_post_settings($this, true, true, false, 4, false);
		...
		Sina_Pro_Woo_Common_Data::nav_styles($this, '.sina-pro-wc-shop-box-carousel');
		Sina_Pro_Woo_Common_Data::dots_styles($this, '.sina-pro-wc-shop-box-carousel');
	}
	...
	protected function render() {
		...
		if ( class_exists( 'WooCommerce' ) ):
			...
			if ( $posts_query->have_posts() ):
				$i = 0;
				?>
				<div class="sina-pro-wc-shop-box-carousel owl-carousel <?php echo esc_attr( $data['dots_position'] ); ?>"
				...
				data-delay="<?php echo esc_attr( $data['delay'] ); ?>">
					<?php while ( $posts_query->have_posts() ) : $posts_query->the_post();
						...
						wp_reset_query();
					?>
				</div><!-- .sina-pro-wc-shop-box-carousel -->
				<?php
			else:
