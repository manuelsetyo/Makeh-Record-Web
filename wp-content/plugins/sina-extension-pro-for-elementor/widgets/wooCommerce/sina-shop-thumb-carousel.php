...
class Sina_Ext_Pro_Shop_Thumb_Carousel_Widget extends Widget_Base{
	...
	public function get_name() {
		return 'sina_ext_pro_shop_thumb_carousel';
	}
	...
	public function get_title() {
		return esc_html__( 'Sina Shop Thumb Carousel', 'sina-ext-pro' );
	}
	...
	protected function _register_controls() {
				...
				[
					...
					'options' => [
						'style1' => [
							...
							'image' => SINA_EXT_PRO_URL .'assets/img/layout/style-7.jpg',
							'width' => '50%',
						],
						'style2' => [
							'title' => esc_html__( 'Style One', 'sina-ext-pro' ),
							'image' => SINA_EXT_PRO_URL .'assets/img/layout/style-8.jpg',
							'width' => '50%',
						],
					],
					'wrap_height' => 100,
		...
		Sina_Pro_Woo_Common_Data::nav_styles($this, '.sina-pro-wc-shop-thumb-carousel');
		Sina_Pro_Woo_Common_Data::dots_styles($this, '.sina-pro-wc-shop-thumb-carousel');
	}
	...
	protected function render() {
		...
		if ( class_exists( 'WooCommerce' ) ):
			...
			if ( $posts_query->have_posts() ):
				$i = 0;
				?>
				<div class="sina-pro-wc-shop-thumb-carousel owl-carousel <?php echo esc_attr( $data['dots_position'] ); ?>"
				...
				data-delay="<?php echo esc_attr( $data['delay'] ); ?>">
					<?php while ( $posts_query->have_posts() ) : $posts_query->the_post();
						...
						wp_reset_query();
					?>
				</div><!-- .sina-pro-wc-shop-thumb-carousel -->
				<?php
			else:
