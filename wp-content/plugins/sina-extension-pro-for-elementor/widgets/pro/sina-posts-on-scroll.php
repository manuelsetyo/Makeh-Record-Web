...
class Sina_Ext_Pro_Posts_On_Scroll_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'sina_ext_pro_posts_on_scroll';
	}
	...
	public function get_title() {
		return esc_html__( 'Sina Pro Posts on Scroll', 'sina-ext-pro' );
	}
	...
	public function get_keywords() {
		return [ 'sina posts on scroll', 'posts scroll' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'loader_icon',
			[
				'label' => esc_html__( 'Loading Icon', 'sina-ext-pro' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'load-dark-one' => esc_html__( 'Dark One', 'sina-ext-pro' ),
					'load-light-one' => esc_html__( 'Light One', 'sina-ext-pro' ),
				],
				'default' => 'load-dark-one',
			]
		);
	...
	protected function render() {
		...
		if ( $post_query->have_posts() ) :
			...
			$posts_data = [
				...
				'posts_excerpt'=> $data['posts_excerpt'],
				'posts_meta'=> $data['posts_meta'],
				'meta_position'=> $data['meta_position'],
				...
				'grid_cats_position' => $data['grid_cats_position'],
				'grid_cats_icon' => $data['grid_cats_icon'],
				'posts_avatar' => $data['posts_avatar'],
				'grid_avatar_size' => $data['grid_avatar_size'],
				'read_btn_bg_layer_effects' => $data['read_btn_bg_layer_effects'],
				'bg_layer_effects' => $data['bg_layer_effects'],
			];
			?>
			<div class="sina-posts-on-scroll <?php echo esc_attr( 'sina-on-scroll-'.$this->get_id() ); ?>"
			...
			data-posts-data='<?php echo json_encode( $posts_data ); ?>'>
				...
				<div class="sina-on-scroll-load-icon">
					<img src="<?php echo esc_url( SINA_EXT_PRO_URL .'assets/img/'. $data['loader_icon'] .'.gif' ); ?>" alt="<?php _e( 'Sina Loading', 'sina-ext-pro' ); ?>">
				</div>

				<?php wp_nonce_field( 'sina_on_scroll_posts', 'sina_on_scroll_posts'.$this->get_id() ); ?>
			</div><!-- .sina-posts-on-scroll -->
			<?php
		else:
			?>
	...
	protected function render_editor_script() {
		...
		jQuery( document ).ready(function( $ ) {
			var sinaOnScrollClass = '.sina-on-scroll-'+'<?php echo $this->get_id(); ?>',
				$this = $(sinaOnScrollClass),
