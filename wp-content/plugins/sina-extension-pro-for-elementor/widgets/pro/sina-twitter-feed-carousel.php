...
class Sina_Ext_Pro_Twitter_Feed_Carousel_Widget extends Widget_Base{
	...
	public function get_name() {
		return 'sina_ext_pro_twitter_feed_carousel';
	}
	...
	public function get_title() {
		return esc_html__( 'Sina Pro Twitter Feed Carousel', 'sina-ext-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'account_name',
			[
				'label' => esc_html__( 'Account Name', 'sina-ext-pro' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter account name', 'sina-ext-pro' ),
				'description' => esc_html__('Use @ in front of your account name.', 'sina-ext-pro'),
				'default' => '@Sina_Extra',
			]
		);
		$this->add_control(
			'consumer_key',
			[
				'label' => esc_html__( 'Consumer Key', 'sina-ext-pro' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter consumer key', 'sina-ext-pro' ),
				'description' => '<a href="https://apps.twitter.com/app/" target="_blank">'.esc_html__('Get Consumer Key', 'sina-ext-pro').'</a>',
			]
		);
		$this->add_control(
			'consumer_secret_key',
			[
				'label' => esc_html__( 'Consumer Secret Key', 'sina-ext-pro' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter consumer secret key', 'sina-ext-pro' ),
				'description' => '<a href="https://apps.twitter.com/app/" target="_blank">'.esc_html__('Get Consumer Secret Key', 'sina-ext-pro').'</a>',
			]
		);
		$this->add_control(
			'feeds_num',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Account Name Styles', 'sina-ext-pro' ),
		...
		Sina_Common_Data::nav_dots_style( $this, '.sina-pro-twitter-feed-carousel' );
		...
		if ( !is_wp_error( $response ) ) {
			...
			if ( isset($body['access_token']) ) {
				...
				if ( !is_wp_error( $twitter_data ) ) {
					...
					?>
					<div class="sina-pro-twitter-feed-carousel owl-carousel"
					...
					data-delay="<?php echo esc_attr( $data['delay'] ); ?>">
						...
						<?php endforeach; ?>
					</div><!-- .sina-pro-twitter-feed-carousel -->
					<?php
				}
			}
		}
